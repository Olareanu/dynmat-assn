...
def submit_jobs():
    ...
    job_names = ["SV-1-", "SV-23-"]  # Replace these with your actual job names
    ...
    for job_name in job_names:
        ...
        try:
            ...
            result = subprocess.run(sbatch_command, shell=True, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
